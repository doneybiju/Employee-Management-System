          ...
          <form onSubmit={submitDept} className="space-y-4 max-w-2xl">
            <div>
              ...
              <input
                ...
                className="w-full p-2.5 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
              />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-500 uppercase mb-1">
                ...
                {pos.map((p, i) => (
                  <div key={i} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 p-2.5 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all"
                    />
                    {pos.length > 1 && (
                      <button
                        type="button"
